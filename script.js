 ...
 * YouTube watch tracking, Google Sheets submission, analytics logging.
 */
...
/* ──────────────────────────────────────
   ...
   ────────────────────────────────────── */
const CONFIG = {
  webhookUrl: '/.netlify/functions/submit-form',
...
function logEvent(event, data = {}) {
  if (!CONFIG.webhookUrl || CONFIG.webhookUrl.includes('[domain]')) {
